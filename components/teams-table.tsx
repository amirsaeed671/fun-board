...
export function TeamsTable({ teams }: { teams: TeamGlobal[] }) {
  ...
  const gridCols =
    "grid gap-2 px-4 grid-cols-[1.75rem_minmax(5rem,1fr)_3.5rem_2rem_2rem_2.5rem_3rem]"
                ...
                {ordered.map((t, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={cn(gridCols, "py-3 items-center", i === 0 && "bg-accent/5")}
                    >
                      <span
                        className={cn(
                      ...
                      <span className="text-sm font-bold font-display tabular-nums text-right text-primary">
                        {metric(t)}
                      </span>
                    </motion.div>
                  )
